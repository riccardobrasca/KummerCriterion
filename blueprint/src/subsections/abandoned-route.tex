...
\begin{theorem}[One-sided Kummer principal reciprocity]
  ...
  \lean{KummerCriterion.Furtwaengler.oneSidedKummerPrincipalReciprocity_canonical}
  \notready
...
\begin{theorem}[Component reflection]
  ...
  \lean{KummerCriterion.weakReflection_componentNontrivial}
  \leanok
...
\begin{theorem}[Reflection-route plus-to-minus implication]
  ...
  \lean{KummerCriterion.weakReflection_dvd_hMinus_of_dvd_hPlus}
  \leanok
...
\begin{theorem}[Ireland--Rosen integer reciprocity]
  ...
  \lean{KummerCriterion.Furtwaengler.IrelandRosen.eisensteinReciprocity_theorem1}
  \leanok
