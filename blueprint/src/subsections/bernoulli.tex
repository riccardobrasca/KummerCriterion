...
\begin{definition}[Generalised Bernoulli number]
  ...
  \lean{BernoulliRegular.BernoulliGen}\leanok
...
\begin{proposition}[$\Bgen{0}{\chi} = 0$ for non-trivial $\chi$]
  ...
  \lean{BernoulliRegular.BernoulliGen_zero_of_ne_one}\leanok
...
\begin{lemma}[Intermediate form for $\Bgen{1}{\chi}$]
  ...
  \lean{BernoulliRegular.BernoulliGen_one_of_ne_one}\leanok
  \uses{def:gen-bernoulli}
...
\begin{lemma}[Cleared form of $\Bgen{1}{\chi}$]
  ...
  \lean{BernoulliRegular.natCast_mul_BernoulliGen_one_of_ne_one}\leanok
...
\begin{proposition}[Parity vanishing at $n = 1$]
  ...
  \lean{BernoulliRegular.BernoulliGen_one_eq_zero_of_even_ne_one}\leanok
...
\begin{theorem}[$p$-integrality of $B_k$ for $k < p - 1$]
  ...
  \lean{BernoulliRegular.bernoulli_mem_padicInt_of_lt_sub_one}\leanok
  \uses{def:gen-bernoulli}
...
\begin{corollary}[Denominator coprimality]
  ...
  \lean{BernoulliRegular.prime_not_dvd_bernoulli_den_of_lt_sub_one}\leanok
...
\begin{theorem}[Von Staudt--Clausen, $p$-local form at $n = p - 1$]
  ...
  \lean{BernoulliRegular.bernoulli_pSubOne_add_inv_p_mem_padicInt}\leanok
  \uses{thm:bernoulli-padicInt-below}
For $p$ an odd prime,
\[
...
\begin{theorem}[Boundary character contribution]
  ...
  \lean{BernoulliRegular.bernoulliGen_teichmuller_inverse_eq_p_sub_one_div_p_add_padicInt}
  \leanok
