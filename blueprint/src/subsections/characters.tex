...
\begin{definition}\label{def:galois-cyclotomic}
  \lean{BernoulliRegular.cyclotomicGalEquivZMod}
  \lean{BernoulliRegular.cyclotomicSigmaOfUnit}
  \lean{BernoulliRegular.cyclotomicGalEquivZMod_sigmaOfUnit}
  \lean{BernoulliRegular.cyclotomicSigmaOfUnit_apply_zeta}
  \leanok
...
\begin{definition}[Teichm\"uller character]
  ...
  \lean{BernoulliRegular.teichmullerCharQp}\leanok
