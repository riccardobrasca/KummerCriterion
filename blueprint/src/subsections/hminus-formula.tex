...
\begin{proposition}\label{prop:odd-L-product-residue}
  \lean{KummerCriterion.residue_ready_factorization_even_odd}
  \leanok
...
\begin{proposition}\label{prop:relative-class-number-L-product}
  \lean{KummerCriterion.hMinus_formula_via_residues}
  \lean{KummerCriterion.hMinus_formula_of_residue_and_hPlus_cyclotomic_and_gauss}
  \leanok
...
\begin{lemma}\label{lem:odd-gauss-product}
  \lean{KummerCriterion.rawGaussProduct}
  \lean{KummerCriterion.cyclotomicHGaussGoal_holds}
  \leanok
...
\begin{theorem}[Analytic formula for \texorpdfstring{$\hminus$}{h-}]
  ...
  \lean{KummerCriterion.hMinus_formula}
  \leanok
