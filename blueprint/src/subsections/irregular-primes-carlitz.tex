...
\begin{theorem}[Full divided Kummer congruence]
  ...
  \lean{BernoulliRegular.bernoulli_div_sModEq_of_modEq_full}
  \leanok
...
\lean{BernoulliRegular.sum_range_pow_sub_p_mul_bernoulli_strong}.
...
\lean{BernoulliRegular.voronoi_congruence_mod_p_strong}.
...
\lean{BernoulliRegular.bernoulli_div_self_mem_padicInt_of_not_sub_one_dvd_voronoi}.
...
\lean{BernoulliRegular.voronoi_floor_sum_sModEq_of_pred_modEq}.
...
\begin{theorem}[Carlitz divisor criterion]
  ...
  \lean{BernoulliRegular.not_isRegularPrime_iff_exists_dvd_bernoulli_div_self_num}
  \leanok
...
\lean{BernoulliRegular.dvd_bernoulli_div_self_num_of_dvd_bernoulli_num}.
...
\lean{BernoulliRegular.sub_one_not_dvd_of_dvd_num_bernoulli_div_self}.
...
\lean{BernoulliRegular.dvd_bernoulli_num_of_padic_congruent_residue}.
...
\begin{definition}[Divisor-closed base]
  ...
  \lean{BernoulliRegular.irregularBase}
  \leanok
...
\begin{theorem}[A new numerator prime outside a finite set]
  ...
  \lean{BernoulliRegular.exists_numerator_prime_for_carlitz_base}
  \leanok
...
\lean{BernoulliRegular.exists_large_even_multiple_abs_bernoulli_div_self_gt_one}
chooses \(t\) such that
\[
...
\lean{BernoulliRegular.exists_prime_dvd_num_of_one_lt_abs}.
...
\lean{BernoulliRegular.not_dvd_num_bernoulli_div_self_of_sub_one_dvd}.
...
\begin{theorem}[Finite-set escape]
  ...
  \lean{BernoulliRegular.exists_not_isRegularPrime_not_mem_carlitz}
  \leanok
...
\begin{theorem}[Infinitely many irregular primes]
  ...
  \lean{BernoulliRegular.infinite_not_isRegularPrime}
  \leanok
...
\lean{BernoulliRegular.infinite_of_forall_finite_set_not_cover}.
\end{proof}
