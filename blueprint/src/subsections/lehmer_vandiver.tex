% Curated, human-readable LehmerVandiver chapter.
...
\begin{definition}
  ...
  \lean{KummerCriterion.LehmerVandiver.IsIrregularIndex}\leanok
...
\begin{definition}
  ...
  \lean{KummerCriterion.LehmerVandiver.VandiverIIIHypothesis}\leanok
...
\begin{theorem}
  ...
  \lean{KummerCriterion.LehmerVandiver.vandiverIIIHypothesis_thirtyseven}\leanok
...
\begin{definition}
  ...
  \lean{KummerCriterion.LehmerVandiver.VandiverIII}\leanok
  \uses{def:vandiverIIIHypothesis}
...
\begin{definition}
  ...
  \lean{KummerCriterion.LehmerVandiver.VandiverIIICaseI}\leanok
  \uses{def:vandiverIIIHypothesis}
...
\begin{definition}
  ...
  \lean{KummerCriterion.LehmerVandiver.VandiverIIICaseII}\leanok
  \uses{def:vandiverIIIHypothesis}
...
\begin{theorem}
  ...
  \lean{KummerCriterion.LehmerVandiver.vandiverIII_of_caseI_caseII}\leanok
...
\begin{theorem}
  ...
  \lean{KummerCriterion.LehmerVandiver.fermatLastTheoremFor_thirtyseven_of_caseI_caseII}\leanok
...
\begin{definition}
  ...
  \lean{KummerCriterion.LehmerVandiver.MirimanoffPolynomialVanishing}\leanok
...
\begin{definition}
  ...
  \lean{KummerCriterion.LehmerVandiver.MirimanoffBernoulliIdentity}\leanok
...
\begin{definition}
  ...
  \lean{KummerCriterion.LehmerVandiver.MirimanoffBernoulliConclusion}\leanok
...
\begin{theorem}
  ...
  \lean{KummerCriterion.LehmerVandiver.caseI_thirtyseven_of_bernoulli_conclusion}\leanok
...
\begin{theorem}
  \label{thm:lehmer_vandiver_not_dvd_hPlus}
  \lean{KummerCriterion.LehmerVandiver.Sinnott.lehmer_vandiver_not_dvd_hPlus}\leanok
...
\begin{definition}
  ...
  \lean{KummerCriterion.LehmerVandiver.VandiverLemma1Thirtyseven}\leanok
...
\begin{theorem}
  ...
  \lean{KummerCriterion.LehmerVandiver.caseII_thirtyseven_of_vandiverLemma1}\leanok
...
\texttt{KummerCriterion/LehmerVandiver/} formalises the
...
\begin{theorem}
  ...
  \lean{KummerCriterion.LehmerVandiver.fermatLastTheoremFor_thirtyseven_of_conclusion_and_vandiverLemma1}\leanok
  \uses{thm:caseI_thirtyseven_of_bernoulli_conclusion,
        ...
        thm:lehmer_vandiver_not_dvd_hPlus}
  If
  \begin{enumerate}
...
to the LehmerVandiver statement above.  They are part of the project's
...
\begin{theorem}
  ...
  \lean{KummerCriterion.LehmerVandiver.Sinnott.sinnottIndexFormula_of_regulatorIdentity}\leanok
...
(\cref{thm:lehmer_vandiver_not_dvd_hPlus}), the proof of
