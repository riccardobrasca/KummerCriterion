...
\begin{theorem}[Special value at zero]
  ...
  \lean{BernoulliRegular.odd_LFunction_zero_eq_neg_BernoulliGen_one}
  \leanok
...
\begin{proposition}\label{thm:fe-reduction}
  \lean{BernoulliRegular.odd_LFunction_one_eq_oddLValueRhs_of_LFunction_inv_zero}
  \leanok
...
\begin{corollary}[Odd character formula at \texorpdfstring{$s=1$}{s=1}]
  \label{cor:L1-odd}
  \lean{BernoulliRegular.odd_LFunction_one_eq_oddLValueRhs}
  \leanok
